  ...
  <body class="properties_listing_grid menu-default hover-default ">
    ...
    <div class="box js-box">
      ...
      <div class="site-wrap js-site-wrap">
        ...
        <div class="center">
          <div class="container" style="width: 96%!important; ">
            <div class="row">
                  ...
                  <div class="widget js-widget widget--main">
                    <div class="widget__content">
                      ...
                      <?php else: ?>
                        ...
                        $fechaFrom  = ($cadena[0] != '-' ? $cadena[0] : '');
                        $fechaTo = ($cadena[5] != '-' ? $cadena[5] : '');
                ...
                if (isset($_GET['city'])){
                    ...
                    <script>
                        $( document ).ready(function() {
                            ...
                            var text = $('#search-string').html();
                            $('#search-string').html(text + ' + ' + '<?=$fechaFrom.' - '.$fechaTo?>');
                        });
                    </script>
                    <?php
              ...
              <div class="sidebar">
                ...
                <div class="widget js-widget widget--sidebar">
                  ...
                  <div class="widget__content">
                    <!-- BEGIN SEARCH-->
                    <form method="get" action="search_advanced.php" id="searchForm" class="form form--flex form--search js-search-form form--sidebar">
                      <div class="row">
                        <?php include('property_form.php'); ?>
                        <div class="form-group">
                          <label for="in-datetime" class="control-label">Date Range</label>
                          <input type="text" id="in-datetime" name="in-datetime" data-start-date="<?=( $cadena[0] != '' ? $cadena[0] : '07/30/2001')?>" data-end-date="<?=( $cadena[5] != '' ? $cadena[5] : date('m/d/Y'))?>" data-time-picker="false" data-single-picker="false" class="js-datetimerange form-control">
                        </div>
