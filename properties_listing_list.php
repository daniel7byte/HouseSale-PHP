        ...
        <a onclick="changeListing('properties_listing_grid_small.php');" class="btn--white"><i class="fa fa-table"></i></a>
                          ...
                          <div class="properties properties--list">
                            ...
                            <div class="properties__details">
                              <div class="properties__info"><a href="property_details.php?id=<?=$row['dato2']?>" class="properties__address"><span class="properties__address-street"><?=$row['dato7']?></span><span class="properties__address-city"><?=$row['dato10'] . ', '. $row['dato11'] . ', GA ' . $row['dato24'] . ', US'?></span></a>
                                ...
                                <div class="properties__params--mob"><a href="#" class="properties__more"><?php echo LISTING_VIEWDETAILS ?></a><span class="properties__params">Built-Up - 65 Sq Ft</span><span class="properties__params">Land Size - 110 Sq Ft</span></div>
                              </div>
          ...
          <div class="sidebar">
            <div class="widget js-widget widget--sidebar">
              ...
              <div class="widget__content">
                <!-- BEGIN SEARCH-->
                <form method="get" action="properties_listing_list.php" id="searchForm" class="form form--flex form--search js-search-form form--sidebar">
                  <div class="row">
			...
			<div class="widget js-widget widget--sidebar widget--dark">
                  <div class="widget__header">
                    <h2 class="widget__title"><?php echo LISTING_POPULARESTATE ?></h2>
                              ...
                              <div class="properties properties--sidebar">
                                <div class="properties__thumb"><a href="property_details.php?id=<?=$row['dato2']?>" class="item-photo item-photo--static"><img src="dinamic_filter/getImages.php?id=<?=$row['dato2']?>&w=483&h=262" width="483" height="262" alt="" />
                                    <figure class="item-photo__hover">
                                      <span class="item-photo__more"><?php echo LISTING_VIEWDETAILS ?></span>
                                    </figure></a>
                                </div>
                                <div class="properties__details">
