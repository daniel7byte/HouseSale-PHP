                ...
                <li class="navbar__item js-dropdown active"><a class="navbar__link">Properties
                  ...
                  <div role="menu" class="js-dropdown-menu navbar__dropdown navbar__dropdown--colls-2">
                    ...
                    <div class="navbar__submenu">
                      ...
                      <ul class="navbar__subnav">
                        <li class="navbar__subitem active"><a href="property_details.html" class="navbar__sublink js-navbar-sublink">Property</a></li>
        ...
        <nav class="breadcrumbs">
          <div class="container">
            <ul>
              ...
              <li class="breadcrumbs__item"><a href="" class="breadcrumbs__link"><?=$result['dato7']?></a></li>
            </ul>
          </div>
        </nav>
        <!-- END BREADCRUMBS-->
...
//echo $archivoveri;
              ...
              <div class="sidebar">
                <div class="widget js-widget widget--sidebar">
                  ...
                  <div class="widget__content">
                    <!-- BEGIN SEARCH-->
                    <form action="properties_listing_grid.php" method="post" class="form form--flex form--search js-search-form form--sidebar">
                      <div class="row">
