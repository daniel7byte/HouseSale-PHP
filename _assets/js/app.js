...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
	  ...
	  var options = {
	    pages: [
	      {url: 'agent_profile.html', name: 'About'},
	  ...
	  var UIpanel = (function () {
	    ...
	    widget.ui = {
	      ...
	      formGroup: function (label, control) {
	          return '<div class="form-group" style="background-color:lime;">' +
	    ...
	    widget.panels = {
	      ...
	      theme_colors: {
	        ...
	        add: function () {
	          ...
	          var formGroup = widget.ui.formGroup('Theme colorsx', control);
	          $uiPanel.append(formGroup);
	    ...
	    widget.init = function (_panels) {
	      ...
	      var htmlBlock = '<div class="ui-panel js-ui-panel" style="background-color:lime!important;"></div>';
