            ...
            <div class="row">
              ...
              <div class="site site--main" style="margin-top:20px;">
                <header class="site__header">
                  <h1 class="site__title">Venta</h1>
                  <h2 class="site__headline">Conozca la mejor manera para vender su propiedad.</h2>
                </header>
                    ...
                    <div class="widget__content">
                      <article class="article article--list article--details">
                        <div class="article__body">
						 ...
						 Nuestra plataforma está a su disposición para realizar la venta efectiva de su bien raíz.    Nos encargamos de asesorarle de la mejor manera para 
						 la comercialización de su bien raíz, ofertándolo en nuestro portal web online.
						  
						  </p>
						  
<p>
						  
Nos encargamos de resaltar todos y cada uno de los detalles de su vivienda como valores agregados para que los interesados logren encontrar en su opción de venta, la ideal para su búsqueda. 
						  ...
						  <br>
						  <blockquote>AHORRE CON NOSOTROS EL 1.5% DEL VALOR DE LA COMISIÓN   </blockquote>
                          <br>
                          <br>						  
						   <!-- Photo by: <a href="http://www.freepik.com">Designed by Pressfoto / Freepik</a> --><img src="assets/media-demo/workers/buy_house.jpg" alt="">
                          <br>
						  <br>
						  <p><strong>Vender en nuestra plataforma es muy  sencillo.</strong></p>
                          <ul>
                              1. Usted deberá diligenciar los datos principales del bien raíz en el formulario que encuentra en 
							  la parte derecha de su pantalla. Tenga en cuenta que deberá incluir información como: Dirección, zip code, su nombre 
							  completo, número telefónico y dirección de correo electrónico.</li>
                            <br>
						    <br>
							2.	Una vez recibida esta información, nos pondremos en contacto con usted lo más pronto posible para iniciar el proceso de venta.
							
							</br>
                            <br>
							3.	Publicaremos su bien raíz en nuestro sitio web para que los visitantes, conozca su propiedad raíz y soliciten información
							
							</br>
							<br>
							4.	Una vez recibimos la solicitud de información, nos encargaremos de inmediato en gestionar el proceso de venta.
							
							</br>
                          </ul>
                          <br>
						  <p><i>ESTAMOS A TAN SOLO UN CLICK: Solo diligencia el formulario que encontrarás a continuación.</i></p>
						 </h4>
                        </div>
...
<div class="actions" id="tfa_0-A"><input type="submit" class="primaryAction" value="ENVIAR"></div>
 ...
 <!-- END site-->	
			  ...
			  <div class="widget js-widget widget--sidebar widget--dark">
                  <div class="widget__header">
                    <h2 class="widget__title">RECOMENDADOS</h2>
