...
<html>
  <head lang="en">
    <meta charset="UTF-8">
    <title>Joygle - Realstate - Español</title><!--[if IE]>
...
<?php include("header.php"); ?> 
      ...
      <div class="site-wrap js-site-wrap">
                ...
                <div class="container">
                  <div class="row">
                    <div class="banner__caption">
                      <h1 class="banner__title">ENCUENTRE AQUÍ SU PRÓXIMO HOGAR</h1>
                      <h3 class="banner__subtitle">
					  Tenemos disponible para usted más de 30.000 propiedades en el estado de Georgia para que elija su mejor opción a un precio más favorable. Ahorre 1.5% con nosotros.
					  </h3><span class="banner__btn" style="color:#fff;">BUSCAR AQUI</span>
                    ...
                    <div class="banner__search">
                      <h4 class="banner__sidebar-title">ENCUENTRE AQUÍ SU PRÓXIMO HOGAR</h4>
                      <!-- BEGIN SEARCH-->
                      <form action="properties_listing_grid_small.php" method="post" class="formpc form form--flex form--search js-search-form form--banner-sidebar " style="">
                        <div class="row">
                          ...
                          <div class="form__buttons form__buttons--double">
                            <button type="reset" onclick="reset();" id="reset" class="form__reset">BORRAR</button>
              ...
              <div class="container">
                <div class="feature__content">
                  <div class="feature__header">
                    <h3 data-sr="enter right ease-in-out 150px" class="feature__title">POR QUÉ USAR JOYGLE</h3>
                    <h4 data-sr="enter right ease-in-out 250px" class="feature__headline">Nuestra plataforma eficiente  brinda todas las herramientas 
					necesarias para que usted pueda comprar ó vender propiedades raíces de la mejor manera. Con nosotros usted obtendrá los siguientes beneficios: </h4>
                  </div>
                  ...
                  <div class="feature__list">
                    <div data-sr="enter right ease 150px" class="feature__item">
                      ...
                      <div class="feature__item-content">
                        <h3 class="feature__item-title">AHORRO DE DINERO</h3>
                        <div class="feature__text">
                          <p>Nuestra comisión es una de las más económicas del mercado: 4.5% .</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div data-sr="enter right ease 250px" class="feature__item">
                      ...
                      <div class="feature__item-content">
                        <h3 class="feature__item-title">Facilitamos la venta</h3>
                        <div class="feature__text">
                          <p>Nos encargamos de gestionar su bien raíz para su tranquilidad.</p>
                        </div>
                      </div>
                    </div>
                    <!-- end of block .feature__item-->
                    <div data-sr="enter right ease 150px" class="feature__item">
                      ...
                      <div class="feature__item-content">
                        <h3 class="feature__item-title">Fácil de Usar</h3>
                        <div class="feature__text">
                          <p>Nuestro buscador simple ofrece diversos filtros para encontrar su vivienda de acuerdo a su necesidad.</p>
                        </div>
                      </div>
                    </div>
                    <!-- end of block .feature__item-->
                    <div data-sr="enter right ease 250px" class="feature__item">
                      ...
                      <div class="feature__item-content">
                        <h3 class="feature__item-title">Diversas opciones</h3>
                        <div class="feature__text">
                          <p>Tenemos más de 30.000 Opciones de vivienda disponibles en el mercado.</p>
                        </div>
                      </div>
                    </div>
                    <!-- end of block .feature__item-->
            ...
            <div data-sr="flip 45deg over 0.5s" class="gosubmit">
              <div class="container">
                <div class="gosubmit__title">
                  <div class="gosubmit__title__row gosubmit__title__row--second"style="text-align: left!important;">
				  <span class="gosubmit__title__option" style="text-align: left!important;">Compramos y vendemos su vivienda </span> 
				  <span class="gosubmit__title__option"></span>
				 <a href="contact.php" class="gosubmit__btn">Contáctenos.</a>
				  </div>					
        ...
        <div class="widget js-widget widget--landing">
          <div class="widget__header">
            <h2 class="widget__title"><span class="title-thin">CONOZCA NUESTROS </span>  ALIADOS ESTRATÉGICOS</h2>
            <h5 class="widget__headline">Trabajamos en conjunto para brindarle una mejor experiencia.</h5>
          </div>
          <div class="widget__content">
            <!-- BEGIN PARTNERS-->
