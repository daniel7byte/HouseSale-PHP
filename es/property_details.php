...
<?php
  ...
  if(!isset($_GET['id'])){
    ...
    <?php
    $query = $mysql->prepare("SELECT * FROM datoscasas WHERE dato2 = :id;");
                    ...
                    <div id="properties-thumbs" class="slider slider--small js-slider-thumbs">
                                      <div class="slider__block js-slick-slider">
                                        ...
                                        while ($contOne<30){
										  ...
										  if($result['id'] == "0"){
											  $archivoveriOne = $direOne.$nomficheOne."_".$contOne.".JPG";
										  }elseif($result['id'] == "1"){
                                          ...
                                          if($result['id'] == "0" && $contOne == 0 && file_exists($archivoveriOneGAFMLS)){
                                            ...
                                            <div data-slide-rel='30' class="slider__item slider__item--0">
                                              <div class="slider__img"><img data-lazy="<?=$archivoveriOneGAFMLS?>" src="<?=$archivoveriOneGAFMLS?>" alt=""></div>
                                            </div>
...
//echo $archivoveri;
                                          if (file_exists($archivoveriOne)) {
                                            ...
                                            list($width, $height, $type, $attr) = getimagesize($archivoveriOne);
                                        ...
                                        <?php
                                            ...
                                            if ($contOne==0) $imginicialOne = $imgdefecto;
                                            break 1;
                                          }
                                          //echo "<br/>";
                                          $contOne++;
                                      ...
                                      <div class="slider__wrap">
                                        <div class="slider__block js-slick-slider">
                                          ...
                                          while ($contTwo<30){
											  ...
											  if($result['id'] == "0"){
												  $archivoveriTwo = $direTwo.$nomficheTwo."_".$contTwo.".JPG";
											  }elseif($result['id'] == "1"){
...
//echo $archivoveri;
                                          ...
                                          <div data-slide-rel='<?=$contTwo?>' class="slider__item slider__item--0">
                                            <div class="slider__img"><img data-lazy="<?=$archivoveriTwo?>" src="<?=$archivoveriTwo?>" alt=""></div>
                                          </div>
                      ...
                      <form action="https://www.tfaforms.com/responses/processor" method="POST" class="form form--flex form--property-agent js-contact-form form--properties">
                        <div class="row">
                          ...
                          <div class="form-group form-group--col-4 required">
                            <label for="in-form-name" class="control-label">Nombre(s)</label>
                            <input id="in-form-name" type="text" name="Name" required class="form-control">
                          </div>
						  
                          <div class="form-group form-group--col-4 required">
                            <label for="in-form-name" class="control-label">Apellido(s)</label>
                          ...
                          <div class="form-group required">
                            <label for="in-form-message" class="control-label">Mensaje : ID (<?=$result['dato2']?>)</label>
              ...
              <div class="sidebar">
                ...
                <div class="widget js-widget widget--sidebar">
                  <div class="widget__header">
                    ...
                    <h5 class="widget__headline">ENCUENTRE AQUÍ SU PRÓXIMO HOGAR</h5><a class="widget__btn js-widget-btn widget__btn--toggle">Show filter</a>
                  </div>
                  <div class="widget__content">
                    <!-- BEGIN SEARCH-->
					...
					<img src="img/banner/banner-tmp2-es.jpg" alt="">
					</div>				  
      ...
      <script type="text/javascript">
        ...
        $(document).ready(function(){
          ...
          <?php
            ...
            // Titulo + Ciudad + Condad +  Estado(GA) ZIP+ US

            $geostr = trim($result['dato7'] . ', ' . $result['dato10'] . ', '. $result['dato11'] . ', GA ' . $result['dato24'] . ', US');
