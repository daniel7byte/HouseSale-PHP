...
<html lang="en">
  <head lang="en">
     <meta charset="UTF-8">
    <title>Joygle - Contáctenos</title>
          ...
          <div class="container">
            <div class="widget js-widget widget--landing">
              <div class="widget__header">
                <h2 class="widget__title">Contáctenos</h2>
                <h5 class="widget__headline">Póngase en contacto con nosotros o envíenos un mensaje en el formulario de contacto.</h5>
              </div>
                      ...
                      <div class="contacts__address">
                        <address class="contacts__address-item"><span class="contacts__address-title">GA</span>
                          <dl class="contacts__address-column">
                            <dt class="contacts__address-column__title">Dir:</dt>
...
<input type="hidden" value="455237" name="tfa_dbFormId" id="tfa_dbFormId"><input type="hidden" value="" name="tfa_dbResponseId" id="tfa_dbResponseId"><input type="hidden" value="1237e026f2b1b993fa33eb6a547302f3" name="tfa_dbControl" id="tfa_dbControl"><input type="hidden" value="4" name="tfa_dbVersionId" id="tfa_dbVersionId"><input type="hidden" value="" name="tfa_switchedoff" id="tfa_switchedoff">
                    ...
                    <div class="contacts__column">
                      <div class="contacts__body">
                        <h4>Nos pondremos en contacto con usted.</h4>
                        <p>
						
Todos nuestros canales de atención están a su disposición para atender sus necesidades y resolver sus inquietudes. Para una atención personalizada, recomendamos que diligencie el formulario con sus datos de 
contacto correctos y le contactaremos en la mayor brevedad posible. Nuestro horario de atención es de lunes a viernes de 8:00 am a 6:00 pm.
					  ...
					  <img src="assets/media-demo/banner/contact_photo.jpg" alt="" style=" width:100%; height:100%;">
                        <div class="social social--worker social--contacts"><span class="contacts__social-title">Redes Sociales:</span>
