...
try {
//$nombre_fichero = $_GET["nomarchivo"];
...
if (file_exists($nombre_fichero)) {
    ...
    $sqlquery = " UPDATE ".$dbname.".datoscasas SET dato5=:dato5,dato6=:dato6,dato24=:dato24
     WHERE dato2=:dato2 ";
    ...
    echo " <br/>New record created successfully ".$last_id . " la cantidad de datos es " . sizeof($arraydatossql) . $sqlquery."  <br/>  ";
	}
	catch(PDOException $e)
    {
    //$conn->rollback();
