            ...
            <div class="row">
              ...
              <div class="site site--main">
                ...
                <div class="site__main">
                  ...
                  <div class="widget__footer"><a href="" class="widget__more" id="loadMore" onclick="loadMore(); return false;">Ver Más Propiedades</a></div>
              ...
              <div class="sidebar">
                ...
                <div class="widget js-widget widget--sidebar">
                  ...
                  <div class="widget__content">
                    <!-- BEGIN SEARCH-->
                    <form method="post" action="properties_listing_grid_small.php" id="searchForm" class="form form--flex form--search js-search-form form--sidebar">
                      <div class="row">
