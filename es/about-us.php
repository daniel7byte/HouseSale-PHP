...
<html>
  <head lang="en">
    <meta charset="UTF-8">
    <title>Joygle - Nuestra Compañia</title>
            ...
            <div class="row">
              ...
              <div class="site site--main">
                <header class="site__header">
                  <h1 class="site__title">Nuestra Compañía </h1>
...
es una plataforma online que trabaja con un grupo de profesionales especialistas en el mercado de bienes raíces; altamente capacitados para cumplir sus 
sueños y mejorar su calidad de vida. A partir de nuestra experiencia y nuestro portal de búsquedas de viviendas, usted  podrá encontrar todos los beneficios 
que espera en la compra ó venta de su propiedad raíz, ubicando el lugar ideal para crecer y vivir feliz, un hogar seguro y lleno de alegría.					 
...
Con Joygle podrá obtener todo el asesoramiento completo de comprar y vivir en una casa: compra, venta, alquiler, financiación, y mucho más.

						 </p>						 
						 
						 
						  <br>
                          <img src="assets/media-demo/workers/agents.jpg"  width="100%" height="100%"  alt="">
						    <!-- <a href="http://www.freepik.com/free-photos-vectors/negocios">Negocios fotografía designed by Pressfoto - Freepik.com</a>e-->
                          <br>
						  <br>
						  <p>
						  
Poseemos la base de datos más segura y fiable del mercado, con más de 30 mil hogares en Georgia. Joygle opera con las suites más popular 
de aplicaciones de bienes raíces en USA, cuenta con todo un canal especializado en cumplir los sueños de sus clientes y satisfacer a las familias americanas. 
						  ...
						  “Somos la mejor opción para brindarle excelentes datos y conocimientos acerca del lugar de sus sueños; su hogar, y 
						  logramos conectarlo con los mejores profesionales locales que lo ayudaran a facilitarle la vida.”
						  
						  </blockquote>
                          </br>
						  <p>
						  
Trabajamos en conjunto con aliados estratégicos como:
...
Recuerde que nosotros no vendemos solo viviendas, sino una oportuna asesoría para que su experiencia con nosotros sea la más llena de confianza en un feliz término de negociación.
						  ...
						  <br>
                          <img src="img/banner/banner-tmp3-es.jpg"  width="100%" height="100%" alt="">
						    <!-- <a href="http://www.freepik.com/free-photos-vectors/negocios">Negocios fotografía designed by Pressfoto - Freepik.com</a>e-->						
			  ...
			  <div class="widget js-widget widget--sidebar widget--dark">
                            ...
                            <div class="listing__item">
                              <div class="properties properties--sidebar">
                                ...
                                <div class="properties__details">
                                  <div class="properties__info"><a href="property_details.php?id=<?=$row['dato2']?>" class="properties__address"><span class="properties__address-street"><?=$row['dato7']?></span>
								  <span class="properties__address-city"><?=$row['dato10'] . ', '. $row['dato11'] . ', GA ' . $row['dato24'] . ', US'?> - <?=($row['id'] == "1" ? 'FMLS' : 'GAMLS' )?></span></a>
                ...
                <div class="widget js-widget widget--sidebar widget--dark">
                  <div class="widget__header">
                    <h2 class="widget__title">Agentes</h2>
                    <h5 class="widget__headline">Disponible 24/7.</h5><a class="widget__btn js-widget-btn widget__btn--toggle"></a>
                  </div>
                  <div class="widget__content">
                    <div class="listing listing--sidebar">
